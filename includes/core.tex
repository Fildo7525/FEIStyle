...
Tu vidíme príklad obdržanej spravy. Jeden z nápadov, ktorý sme mali bolo premeniť toto číslo na desatinne čísla, keďže sme mu posielali desatinne čísla.
Problém je v tom, že keď posielame request na nastavenie rýchlosti kolies tak kód na robote funguje tak že si to premení na cele čísla v rozsahu 0 až 1000
a to je hodnota, na ktoré nastaví rýchlosti otáčania kolies. Na druhu stranu keď si vypýtame od robota rýchlosti kolies tak zoberie informáciu z enkóderov
...
\noindent Ako môžeme vidieť v týchto predpisoch funkcii bolo treba zmeniť ten názov funkcie a ostatne parametre ostali rovnaké.
