...
Táto podobnosť končí na najvyššej vrstve. Ako sme videli na Obr.~\ref{o_struktury}. Štruktúra ROS2 je rozdelená do viacerých vrstiev.
...
Robot, s ktorým sme pracovali bol výsledkom tímového projektu viacerých študentov. Pri vysvetľovaní a opisovaní robota sa budeme odvolávať na dokumenty, stránky a kód,
ktorý napísali. Všetky tieto údaje si sprístupnené na robote v záložke \texttt{\$(HOME)/Desktop/Blackmetal}~\cite{timovyProjekt}.
