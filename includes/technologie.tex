% !TEX root = ../main.tex
\section{Analýza použitých informačných technológií}
...
Kvôli takýmto problémom a~nedostatkom sa začala vyvíjať nová verzia ROS2. Tá mala vyriešiť tieto problémy a~zlepšiť funkcionalitu
...
funkciu \textbf{Delegátora zdrojov} na~čítanie a~zapisovanie dát do~jednotlivých komponentov. Mienime si preto~vytvoriť
