...
\label{sec:ovladanie}
	...
	existujúci kód (parser), ktorý by nám zjednodušil prehľadávanie týchto správ. Podľa dokumentácie sa robot mal ovládať správami typu~\cite{BMdoc}
	...
	Spracovanie týchto správ je spravená v samostatnom vlákne. Toto vlákno je vytvorene pomocou metódy \textbf{polling}.
