...
\begin{itemize}
	\item \textbf{Prešmyk} Robot môže na~mieste prešmykovať. To~ma za~dôsledok nepresne uvedenie polohy robota.
	\item \textbf{Oneskorenie komunikácie} Dáta z~ovládača prijmeme vo~while cykle so~softvérovým oneskorením (100ms)
		plus \cite{timovyProjekt}. Tým, že sa môže komunikácia oneskoruje, tak~sa vnáša chyba do~výpočtu aktuálnej polohy
