...
\begin{itemize}
	\item \textbf{Prešmyk} Robot môže na~mieste prešmykovať. To~má za~dôsledok nepresné uvedenie polohy robota.
...
vzhľadom na~robot. Filtrované dáta by boli až veľmi skreslené.
